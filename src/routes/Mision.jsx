...
const Mision = () => {
    return (
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-6">
          ...
          >
            <h3 className="text-xl font-semibold text-teal-600">Education for All</h3>
            <p className="mt-2">
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.05 }}
          >
            <h3 className="text-xl font-semibold text-teal-600">Skill Development</h3>
            <p className="mt-2">
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.05 }}
          >
            <h3 className="text-xl font-semibold text-teal-600">Health & Hygiene</h3>
            <p className="mt-2">
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.05 }}
          >
            <h3 className="text-xl font-semibold text-teal-600">Environment Protection</h3>
            <p className="mt-2">
